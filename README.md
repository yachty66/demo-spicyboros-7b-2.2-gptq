...
# Banana.dev Spicyboros-7B-2.2-GPTQ starter template

This is a Spicyboros-7B-2.2-GPTQ starter template from [Banana.dev](https://www.banana.dev) that allows on-demand serverless GPU inference.
...
1. [Fork this](https://github.com/yachty66/demo-spicyboros-7b-2.2-gptq/fork) repository to your own Github account.
